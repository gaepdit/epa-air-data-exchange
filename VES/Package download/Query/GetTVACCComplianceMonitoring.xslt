    ...
    <xsl:template match="v1:DataSet">
		...
		<AirTVACCData xmlns="http://www.exchangenetwork.net/schema/icis/5">
			...
			<AirTVACC>
					...
					<xsl:for-each select="//v1:record[v1:TransactionID=$TransactionID][v1:ComplianceMonitoringId=$ComplianceMonitoringId][v1:TVACCReviewDataId!=''][not(self::v1:record/v1:TVACCReviewDataId=following-sibling::v1:record/v1:TVACCReviewDataId)]">
					<TVACCReviewData>
