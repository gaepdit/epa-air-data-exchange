...
SELECT EnforcementAction.EnforcementActionId, EnforcementAction.EnforcementActionTypeCode,
       EnforcementAction.EnforcementActionName, EnforcementAction.ResolutionTypeCode,
       ...
       EAComment.CommentText, EAGovernmentContact.ContactId, Contact.AffiliationTypeText, Contact.FirstName,
       Contact.MiddleName, Contact.LastName, Contact.IndividualTitleText, Contact.OrganizationFormalName,
       Contact.StateCode, Contact.RegionCode, Contact.ElectronicAddressText, Contact.StartDateOfContactAssociation,
       Contact.EndDateOfContactAssociation, EnforcementAction.TransactionID,
